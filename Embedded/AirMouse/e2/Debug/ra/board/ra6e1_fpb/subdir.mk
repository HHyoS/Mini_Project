...
C_SRCS += \
../ra/board/ra6e1_fpb/board_init.c \
../ra/board/ra6e1_fpb/board_leds.c 

C_DEPS += \
./ra/board/ra6e1_fpb/board_init.d \
./ra/board/ra6e1_fpb/board_leds.d 

OBJS += \
./ra/board/ra6e1_fpb/board_init.o \
./ra/board/ra6e1_fpb/board_leds.o 
...
ra/board/ra6e1_fpb/%.o: ../ra/board/ra6e1_fpb/%.c

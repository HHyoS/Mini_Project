...
자율주행에서 차선을 이탈하지 않고 주행하는것은 중요한 기능입니다. 그 기능을 구현하여 차량에 테스트하는것은 어렵고 위험하다고 생각합니다. 그래서 차량과 비슷한 조작이 가능한 rc카를 이용하여 영상처리기반 자율주행을 구현하고, 영상처리 자율주행의 장점과 개선점을 직접 알아보고자 프로젝트를 진행하게 되었습니다. 

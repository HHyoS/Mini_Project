...
let clickCount = 0;
let score = 0;
const width =  getComputedStyle(document.querySelector(".column")).width;
const height = getComputedStyle(document.querySelector(".row")).height;
const scoreChange = document.querySelector(".point");
